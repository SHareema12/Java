...
public class Employee {
	...
	public Employee(int employeeId, String firstName, String lastName, Date employmentDate, double annualSalary) {
	...
	public String toString() {
		...
		return String.format(
				"Employee with id=%d, firstName=%s, lastName=%s, employment date=%s, deptInfo:%s, annualSalary=%f",
				employeeId, firstName, lastName, fmt.format(employmentDate), (dept == null ? "" : dept.toString()),
				annualSalary);
	}
